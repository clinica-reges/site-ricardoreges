# P1 — Cirurgia a Laser e Tratamentos Minimamente Invasivos da Próstata
**Copy para revisão médica · Dr. Ricardo Reges · rascunho v1 (2026-07-05)**
*Marcadores [CONFIRMAR: …] exigem sua validação antes de publicar. Nada aqui promete resultado; datas e números devem sobreviver a auditoria.*
...
## S1 — O problema, na língua do paciente
...
## S3 — Qual técnica para qual caso
...
*(link cruzado: Avaliação e diagnóstico → página de urodinâmica)*
*(link cruzado: EchoLASER — ablação transperineal para casos selecionados de HPB → P3)*

---

## S4 — As duas perguntas que todo homem quer fazer (e às vezes não pergunta)

**"Vou ficar incontinente?"**
É a pergunta mais importante — e merece resposta com números, separando duas coisas diferentes:

**Escape temporário (transitório):** nas primeiras semanas após a enucleação, parte dos pacientes apresenta algum grau de escape — os estudos reportam tipicamente entre 8% e 17% dos casos, com a grande maioria recuperando o controle completo nos primeiros 3 meses; numa das maiores séries publicadas, quase 90% dos casos transitórios resolveram já nas primeiras 6 semanas¹⁻³. É parte esperada da recuperação: a bexiga e o esfíncter passaram anos trabalhando contra a obstrução e precisam de um período de readaptação. Fisioterapia do assoalho pélvico acelera essa fase quando indicada.

**Incontinência definitiva (que persiste e requer tratamento):** essa é rara — na ordem de 1,5% a 2,7% na literatura¹·⁴. E mesmo nesses casos incomuns existe tratamento eficaz, incluindo o esfíncter urinário artificial nos casos graves — que é uma das subespecialidades do Dr. Ricardo Reges. Aqui, o compromisso com a sua continência não termina na cirurgia. *(link → P4)*
...
*(slot de vídeo: Short "Cirurgia de próstata e vida sexual: o que é mito")*
...
- **Retorno ao trabalho:** atividades leves em poucos dias; esforço físico e atividade sexual, em geral, liberados entre 2 e 4 semanas [CONFIRMAR].
- **Resultado:** a melhora do jato costuma ser percebida de imediato; o padrão urinário segue refinando ao longo de semanas.

*(elemento visual: linha do tempo simples D0 → D2 → semana 1 → semana 4)*

---

## S6 — Por que o Dr. Ricardo Reges
...
Na maioria dos casos, 1 a 2 diárias [CONFIRMAR]. O Rezūm é ambulatorial.

**Quando volto a dirigir e trabalhar?**
Atividades leves e direção em poucos dias; trabalho de esforço físico, em geral, após 2 a 4 semanas [CONFIRMAR].
...
**[CTA] Agendar avaliação** → booking DocFlow com `?utm_source=site&utm_medium=cta&utm_campaign=laser-prostata`
**[Alternativa]** Prefere falar com a equipe? WhatsApp da clínica: (85) 99698-3366

---

## Referências (seção recolhível no site — diferencial de credibilidade)
...
*[NOTA PARA RICARDO: os números acima vieram de busca de hoje (2026-07-05) nas fontes indicadas. Antes de publicar, valide cada taxa contra sua leitura da literatura e ajuste as referências para o formato final (autor, título completo, periódico, ano, DOI). Se preferir citar diretrizes (AUA/EAU) em vez de séries individuais, os intervalos são compatíveis.]*

---

*[Rodapé da página]*
*Conteúdo informativo, em conformidade com as normas de publicidade médica do Conselho Federal de Medicina. As informações desta página não substituem a consulta médica; indicações e resultados variam caso a caso.*

---

## Notas técnicas (não publicar — para a fase de construção)
